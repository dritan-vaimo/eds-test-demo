...
## Environments
- Preview: https://main--eds-test-demo--dritan-vaimo.hlx.page/
- Live: https://main--eds-test-demo--dritan-vaimo.hlx.live/
...
1. Open the `eds-test-demo` directory in your favorite IDE and start coding :)
